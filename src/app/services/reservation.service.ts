...
import { ReservationRequest, ReservationResponse, ReservationDetailResponse } from '../models';
...
export class ReservationServiceApi {
  ...
  detail(trackingId: string): Observable<ReservationDetailResponse> {
    return this.http.get<ReservationDetailResponse>(`${this.base}/detail/${trackingId}`);
  }
  ...
  detailForCompagnie(compagnieTrackingId: string, reservationTrackingId: string): Observable<ReservationDetailResponse> {
    return this.http.get<ReservationDetailResponse>(`${this.base}/compagnie/${compagnieTrackingId}/detail/${reservationTrackingId}`);
  }
