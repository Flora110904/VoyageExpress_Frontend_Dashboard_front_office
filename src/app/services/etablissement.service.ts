...
export class EtablissementServiceApi {
  ...
  getByProprietaire(proprietaireTrackingId: string): Observable<EtablissementResponse> {
    return this.http.get<EtablissementResponse>(`${this.base}/proprietaire/${proprietaireTrackingId}`);
  }
